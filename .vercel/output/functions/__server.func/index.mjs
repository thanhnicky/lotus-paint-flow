...
const services = {
  ["ssr"]: lazyService(() => import("./_ssr/index-DA_wsVEU-v2.mjs"))
};
...
const _lazy_Sb9Q_x = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
const findRoute = /* @__PURE__ */ (() => {
  const data = { route: "/**", handler: _lazy_Sb9Q_x };
  return ((_m, p) => {

...
const appCss = "/assets/styles-RT6UhumR-v2.css";
...
const $$splitComponentImporter$1 = () => import("./thank-you-Bu80pdot-v2.mjs");
...
const $$splitComponentImporter = () => import("./index-_nPQuRUE-v2.mjs");
